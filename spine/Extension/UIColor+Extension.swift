...
extension Color {
    ...
    static let lightBrown2 = Color(hex: 0xD7C7B5)//D7C7B5
    //static let lightBrown3 = Color(hex: 0xB79888)//B79888
    static let lightGray1 = Color(hex: 0xD8D8D8)
    static let lightGray2 = Color(hex: 0xADADAD)
    //static let lightGray3 = Color(hex: 0xBDBDBE)
    static let lightGray4 = Color(hex: 0xCFD0CF)
    static let lightGray5 = Color(hex: 0xF4F4F4)
    static let lightBlackText = Color(hex: 0x707070)
    static let placeHoldertxtClr = Color(hex: 0xA8B6C8)
    static let lightBlue = Color(hex: 0xA8B6C8)
    static let orange1 = Color(hex: 0xFA6400)
